...
void stm32_pin_write(device_t dev, base_t pin, base_t value)
{
    const struct pin_index *index;
...
int stm32_pin_read(device_t dev, base_t pin)
{
    int value;
    const struct pin_index *index;
...
void stm32_pin_mode(device_t dev, base_t pin, base_t mode)
{
    const struct pin_index *index;
...
int stm32_hw_pin_init(void)
{
    ...
    result = device_pin_register("pin", &_stm32_pin_ops, NULL);
    return result;
}
